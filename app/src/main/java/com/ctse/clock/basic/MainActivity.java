...
//            public void run() {
//                mTime.setToNow();
//                MainActivity.drawingView dv = new MainActivity.drawingView(MainActivity.this,mTime.hour,mTime.minute,mTime.second,mTime.weekDay,mTime.monthDay,getBatteryLevel());
//                setContentView(dv);
...
//        handler.postDelayed(r,1000);
    ...
    public class drawingView extends View {
        ...
        public drawingView(Context context, int hours, int minutes, int seconds, int weekday, int date, float battery) {
            super(context);
            tf = Typeface.createFromAsset(getAssets(), "digital-7 (mono).ttf");
